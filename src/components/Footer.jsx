function Footer() {
  ...
  return (
    <footer className="bg-slate-950 border-t border-slate-800/80 text-white">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center justify-between pb-8 border-b border-slate-800/80">
          {/* Brand Info */}
          <div>
            <a href="#home" className="text-2xl font-bold tracking-tight text-white flex items-center gap-2">
              <span className="w-8 h-8 rounded-lg bg-cyan-500 text-slate-950 font-extrabold flex items-center justify-center text-sm">
                JS
              </span>
              Justin <span className="text-cyan-400">Santhosh</span>
            </a>
            <p className="text-slate-400 text-sm mt-2 max-w-sm">
              MCA Student & Full Stack Developer based in Kerala, India. Crafting modern, scalable web solutions.
            </p>
          </div>
          ...
          <div className="flex justify-start md:justify-end items-center gap-4">
            <a
              ...
              className="p-2.5 rounded-xl bg-slate-900 border border-slate-800 text-slate-300 hover:text-cyan-400 hover:border-cyan-400/50 transition"
              title="GitHub"
            >
        ...
        <div className="pt-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-slate-500">
          <p>© {year} Justin Santhosh. Built with React & Tailwind CSS.</p>
          <p className="flex items-center gap-2">
            <span>Portfolio:</span>
            <a
              href="https://justin-santhosh-portfolio.vercel.app"
              target="_blank"
              rel="noopener noreferrer"
